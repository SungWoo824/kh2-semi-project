...
<body>
	...
	<div class="backBody">
		...
		<div id="wrap">
	<form name="review" action="review_edit.do"  method="post" enctype="multipart/form-data">
<!-- 		예약번호:<input type="text" name="reservation_no"><br>
		...
		<textarea class="noresize" name="review_content" rows="10" cols="100" style="font-size: 1.5rem;"><%=dto.getReview_content() %></textarea>
			<div class="block"></div>
			<div class="block"></div>
			<div class="block"></div>
		</div>	
		...
		<div style="font-size: 1.5rem;">별점을 메겨주세요</div>
			<p id="star_grade">
        		...
        		<input type="hidden" name="star_point" id="star" value="<%=dto.getStar_point()%>">
			</p>
